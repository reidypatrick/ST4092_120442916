...
Regression, as the earliest and simplest form of modelling [1], has been used in a variety of predictive applications due to its ease of interpretation and implementation. However, it struggled to handle the complexities of insurance data, which often include non-linear relationships. Consequently, Generalized Linear Models emerged as a significant advancement, offering a more flexible framework that accommodated various distribution families and data types. GLMs excelled in modelling discrete and continuous outcomes while retaining interpretability, making them the go-to choice for many years.
