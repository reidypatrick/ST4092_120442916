...
# backward elimination takes a while to run, for brevity's sake and testing
...
```{r nnFit, include = TRUE, echo = FALSE}
...
draw_network_from_model(model = best_model, name = "figNetwork", show = TRUE)
```

```{r nnFig, include = TRUE, echo = FALSE}
knit_draw_model("figNetwork")
```
