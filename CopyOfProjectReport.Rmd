...
```{r glmSummary, include = TRUE, echo = FALSE}
summary(glm1)
```

Where:
• “ClaimNb \~ .”: is the formula, signifying ClaimNb as the response variable and including all other
...
```{r glmBackSummary, include = TRUE, echo = FALSE}
...
```{r glmPredictions, include = TRUE, echo = FALSE, out.width = "100%"}
